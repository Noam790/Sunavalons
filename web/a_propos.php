    ...
    <main class="container">
        ...
        <section class="apropos-section">
            ...
            <section class="project-description">
                ...
                <p>
                    Dans le cadre de ce projet notre groupe a trouvé pertinent de réaliser un site
                    web permettant aux habitants d'une ville de pouvoir avoir une idée précise de quels arbres planter où, voire plus
                    d'outils si les moyens et le temps le permettaient.
                </p>
                <p>
                    Ce projet regroupe donc plusieurs domaines informatiques
